<?php /* Smarty version 2.6.20, created on 2015-11-30 11:48:16
         compiled from registrar.usuario.tpl */ ?>
<!DOCTYPE HTML>
<html>
<head>
...
function validarEspacioBlancoUsuario() {
        var er = new RegExp(/\s/);
...
function validarEspacioBlancoContrasenia() {
        var er = new RegExp(/\s/);
              ...
              <td width="70%" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td height="352" valign="top">
                    ...
                    <h2>Llene el siguiente formulario para tener acceso a <?php echo $this->_tpl_vars['aplicacion']; ?>
.
                  </div></td>
                      </tr>
                      <tr>
                        ...
                        <tr>
                          ...
                          <td width="70%" align="left"><span id= 'camp1'>
                            <input name="capepatusu" type="text" id="capepatusu" size="30" maxlength="50" class="camposform" value="<?php echo $this->_tpl_vars['capepatest']; ?>
" />
                        ...
                        <tr>
                          ...
                          <td align="left"><span id= 'camp3'>
                            <input name="cnomusu" type="text" id="cnomusu" size="40" maxlength="70" class="camposform" value="<?php echo $this->_tpl_vars['cnomest']; ?>
" />
                            <span class='textfieldRequiredMsg'>Campo requerido.</span></span></td>
</tr>
                        <tr>
                          ...
                          <td width="70%" align="left"><span id= 'camp4'>
                            <input name="cnomemp" type="text" id="cnomemp" size="30" maxlength="50" class="camposform" value="<?php echo $this->_tpl_vars['capepatest']; ?>
" />
                            <span class='textfieldRequiredMsg'>Campo requerido.</span></span></td>
</tr>
                        <tr>
