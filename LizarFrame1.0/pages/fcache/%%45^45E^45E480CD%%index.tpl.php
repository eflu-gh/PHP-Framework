<?php /* Smarty version 2.6.20, created on 2015-09-08 19:15:03
...
<body link="#0000ff" vlink="#0000ff" alink="#0000ff" onLoad="popUp('<?php echo $this->_tpl_vars['popup']; ?>
');" scroll="no">
<div align="center">
<p></p>
<p><a href="javascript:" onClick="popUp('<?php echo $this->_tpl_vars['popup']; ?>
');"></a></p>
<p><a href="javascript:" onClick="popUp('<?php echo $this->_tpl_vars['popup']; ?>
');"><img src="../../.res/_img/_opt/link.png" width="16" height="16" border="0" align="absmiddle" /> Haga click aqu&iacute; para ingresar al sistema</a><br />
  <br />
  <br />
<br />
<br />
...
<p><span class="Estilo5"><br />
  ...
  <br />
  <br />
  Powered by: <?php echo $this->_tpl_vars['desarrollador']; ?>
 -
